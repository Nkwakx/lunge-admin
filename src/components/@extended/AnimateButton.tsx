...
export default function AnimateButton(
  { children, type = 'scale', direction = 'right', offset = 10, scale = { hover: 1.05, tap: 0.954 } } : 
  { children: ReactNode, type?: string, direction?: string, offset?: number, scale?: { hover: number, tap: number } }) {
  let offset1;
  let offset2;
  switch (direction) {
    case 'up':
